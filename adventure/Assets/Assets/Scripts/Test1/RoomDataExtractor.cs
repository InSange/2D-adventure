...
public class RoomDataExtractor : MonoBehaviour
{
    ...
    public void ProcessRooms()
    {
        ...
        Vector2 playerRooomPos = dungeonData.Rooms[dungeonData.PlayerSpawnRoomIndex].RoomCenterPos;
        dungeonData.Rooms = dungeonData.Rooms.OrderBy((pos) => (pos.RoomCenterPos - playerRooomPos).sqrMagnitude).ToList();
        dungeonData.Rooms[dungeonData.PlayerSpawnRoomIndex].PlayerRoom = true;
        dungeonData.Rooms.Last().FinishRoom = true;
